    ...
    public static class BotExtensions
    {
        ...
        public static Func<NancyContext, Response> AuthenticateBot(INancyModule module)
        {
            return ctx =>
            {
                ...
                var identity = tokenExtractor.GetIdentityAsync(ctx.Request.Headers.Authorization).Result;
                ...
                if (identity == null && !DisableSelfIssuedTokens)
                {
                    ...
                    identity = tokenExtractor.GetIdentityAsync(ctx.Request.Headers.Authorization).Result;
